...
class Config:
    ...
    # 语言自然化启用时预填，用户仍可按本次文章需要自由修改。
    DEFAULT_DEAI_PROMPT = (
        '这是一篇需要去除AI写作风格的文章，请审阅并修改本文，移除所有类似'
        '“然而”、“此外”、“总之”、“因此”、“综上所述”、“例如”、“基于此”、'
        '“显而易见”、“值得注意的是”、“不可否认”、“从某种程度上”、“换句话说”、'
        '“由于……原因”、“尽管如此”、“由此可见”、“因此可见”、“不可避免地”、'
        '“事实上”、“一方面……另一方面”、“显著”、“通过……可以看出”、'
        '“在此基础上”、“尤其是”、“根据……”、“基于以上分析”、“毫无疑问”、'
        '“值得一提的是”、“相较于”、“可见”、“因此可以推断”、“进一步而言”、'
        '“如上所述”、“结合实际情况”、“综合考虑”、“在此过程中”、“进一步分析”、'
        '“在一定程度上”、“相反”、“尤其值得关注”、“从而”、“上述”、“这表明”、'
        '“首先”、“其次”、“最后”、“第一”、“第二”、“第三”、“另外”、“再者”、'
        '“接下来”、“然后”、“最终”、“进一步”、“由此”、“因为”、“所以”、'
        '“由此可见”、“总的来说”、“总结一下”、“简而言之”、“结果是”、“如前所述”、'
        '“在的基础上”、“总之”、“说到最后”、“当然”等词汇。请确保文章流畅自然，'
        '避免使用上述列表中的任何词语或短语，并保持文章原意不变。如果发现有难度去除'
        '某些词汇而不影响句意表达，请尽可能替换而非删除，并确保句子连贯。'
    )
